        ...
        <div class=" row d-flex   justify-content-center ">
            ...
            <div class="row third-section d-flex justify-content-center ">
                <div class=" text-white d-flex justify-content-between col-md-2 px-5 py-3 border my-1">
                    ...
                    <form action="{{ route('antecedent.update', ['antecedent'=>$antecedent->id]) }}" method="post">
                        @csrf
                        @method('PUT')
                        <input name="name" type="text" value="{{$antecedent->name}}" class="mb-3 form-control" required>
