    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">Modifier la categorie</h4>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="card shadow p-3 mb-3 bg-body rounded col-md-10">
                <div class="card-body">
                    <form action="{{ route('categorie.update', ['categorie'=>$categorie->getId()]) }}" method="post">
                        @csrf
                        @method("PUT")
                        <div class="col-md-10">
                            <div class="mt-4 mt-md-0 ">
                                ...
                                <input class="form-control form-control-sm" type="text" placeholder="nom du pays"
                                    name="categorie" autocomplete="off" required value="{{$categorie->getName()}}">
                                @if ($errors->has('code'))
