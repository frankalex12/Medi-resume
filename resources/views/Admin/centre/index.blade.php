...
@section('contenu')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h1 class="mb-0 ">Centre hospitaliers</h1>
            </div>
        </div>
    </div>
    <div class="row my-2">
    ...
    <div class="row d-flex  mb-5">
        <div class="col-md-8 d-flex">
            ...
            <div>
                <select class="selectpicker form-control" data-live-search="true">
                    <option data-tokens="ketchup mustard">specialites</option>
                </select>
            </div>
            <div>
                <select class="selectpicker form-control" data-live-search="true">
                    <option data-tokens="ketchup mustard">Sous Categories</option>
                </select>
            </div>
        </div>
                        ...
                        <table class="table table-editable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Numero d'identification</th>
                                    <th class="text-center">Email du responsable</th>
                                ...
                                @foreach ($centres as $centre)
                                    <tr class="h-25">
                                        ...
                                        <td class="text-center ">
                                                ...
                                                {{ $centre->Numero_identification }}

                                        </td>
                                        <td class="text-center pt-3 ">


                                                {{ $centre->email_responsable }}

                                        </td>
                                        <td class="text-center">
                                            <a class="dropdown-item btn-sm text-success text-center pt-3" href="">
                                                Actif
                                            </a>
                                        </td>
                                        <td class="text-center pt-4">
                                            <div class="btn-group ml-md-2 mb-3">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right ">
                                                    <a class="dropdown-item text-secondary text-center" href=" {{ route('admin.hopitals.show', ['id'=>$centre->id])}}">
                                                        <i class="fas fa-eye"></i> Profil</a>
