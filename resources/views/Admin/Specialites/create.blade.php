        ...
        <div class="row">
            <div class="col-md-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <h4 class="mb-0 font-size-18">Nouvelle Specialite</h4>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-md-10">
                            <div class="mt-4 mt-md-0 mb-4 ">
                                ...
                                <input class="form-control form-control-sm" type="text" placeholder="nouvelle specialite"
                                    name="specialite" autocomplete="off" required>
                                @if ($errors->has('specialite'))
                                    <p class="text-danger">veuillez renseigner la specialite </p>
                                @endif
                            </div>
                            <select class="selectpicker form-control form-control" data-live-search="true" name="gorupespecialite">
                                @foreach ( $gorupespecialites as $gorupespecialite )
                                <option value="{{$gorupespecialite->getId()}}">{{$gorupespecialite->getName()}}</option>
                                @endforeach
                            </select>
