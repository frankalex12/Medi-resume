    ...
    <div class="container-fluid">
        ...
        <div class="row d-flex justify-content-center mb-3 mt-5">
            <div class="col-md-6 d-flex">
                <a href="{{ route('personnels.create') }}" class="btn btn-primary btn-sm mb-2 px-3">Créer un personnel</a>
            </div>
                            ...
                            <table class="table table-editable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">{{$personnel->naissance}}</td>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group ml-md-2 mb-3">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right ">
                                                    <a class="dropdown-item text-secondary text-center" href="{{ route('personnels.show', ['personnel'=>$personnel->id]) }}">
                                                        <i class="fas fa-eye"></i> Profil
                                                    </a>
                                                    <a class="dropdown-item text-success text-center" href="{{ route('personnels.edit', ['personnel'=>$personnel->id]) }}">
